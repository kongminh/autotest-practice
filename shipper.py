...
WebDriverWait(driver, wait_load_page).until(EC.url_changes(current_url))
...
WebDriverWait(driver, wait_select_box).until(EC.presence_of_element_located((By.XPATH, "//div[@class='q-virtual-scroll__content']//div[@class='q-item__label'][contains(text(), 'nông')]"))).click()
...
# time.sleep(wait_select_box)
# driver.implicitly_wait(wait_select_box)
WebDriverWait(driver, wait_select_box).until(EC.element_to_be_clickable((By.XPATH, "(//*[@id='new-request-steps']//div[contains(@class, 'q-field__control-container')])[4]"))).click()
# unit_of_cargo = driver.find_element_by_xpath("(//*[@id='new-request-steps']//div[contains(@class, 'q-field__control-container')])[4]")
# log(unit_of_cargo.get_attribute('innerHTML'))
# unit_of_cargo.click()

WebDriverWait(driver, wait_select_box).until(EC.presence_of_element_located((By.XPATH, "//div[@class='q-virtual-scroll__content']//div[@class='q-item__label'][contains(text(), 'Bao')]"))).click()
...
WebDriverWait(driver, wait_select_box).until(EC.presence_of_element_located((By.XPATH, '//*[@id="new-request-steps"]//div[contains(text(), "Địa điểm bốc hàng")]')))

load_location = driver.find_element_by_xpath('//*[@id="origin"]')
load_location.send_keys(u'Hà Nội')

WebDriverWait(driver, wait_select_box).until(EC.presence_of_element_located((By.XPATH, '//div[contains(@class, "pac-container")]')))
